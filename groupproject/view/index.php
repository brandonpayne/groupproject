...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="js/fixedbg.js"></script>
    </head>
    <body>
        <!--[if lt IE 7]>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-10 main-menu text-right">
                                    ...
                                    <ul class="menu-first">
                                        ...
                                        <li><a href="#portfolio">Shoes</a></li>
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    <h2>New Responsive Theme</h2>
                                    <p>Download, edit and use it for your website</p>
                            ...
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    ...
                                    <p>High quality design and coding</p>
                        ...
                        <div class="service-item" id="service-1">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>HTML5 Coding</h3>
                                   <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim, assumenda, eveniet, consectetur, ex doloribus veniam asperiores incidunt mollitia placeat aniet adipscing.</p> 
                                </div>
                            </div> 
                        </div> 
                    </div> 
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="service-item" id="service-3">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>Our Design</h3>
                                   <p>We create <a href="#">mobile website templates</a> that are responsive for any screen size on any device. Feel free to download and use our templates without restrictions.</p> 
                                </div>
                            </div> 
                        </div> 
                    </div>
        ...
        <div class="content-section" id="portfolio">
            <div class="portfolio-background">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Our Brands</h2>
                        <p>Our four most popular brands</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
                <div class="row">
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="images/logos/vanslogo.jpeg" alt="">
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="images/logos/adidaslogo.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Boat</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="adidas.php"  class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="images/logos/nikelogo.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Urban</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="images/logos/crocslogo.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Cycling</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-6">
                        <p><a rel="nofollow" href="http://www.templatemo.com/tm-406-flex" target="_parent">Kix</a> is a non profit company that strives to get you the newest kicks for a legitimate price.  We understand not everybody can afford the newest most popular shoes,
                                                                                                                    so we buy straight from the production so you will save tons more buying from us than buying from the brand.  Big companies are getting huge margin profits off selling
                                                                                                                    brand name shoes.  We want to sell you the same shoe for face value.  No more paying over $500 for a pair of shoes!<br><br>Lets get away from paying so much to these
                                                                                                                    big name shoe companies and start being real with ourselves.                        </p>
                        <ul class="contact-info">
                            <li>Phone: 801-555-1472</li>
                            <li>Email: <a href="support@kix.com">support@kix.com</a></li>
                            <li>2500 State St, Salt Lake City</li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 text-left">
                        <span>Copyright &copy; 2016 Kix Shoes 
                        
                        | Design: <a rel="nofollow" href="http://www.templatemo.com/tm-406-flex" target="_parent">Payne&Camden</a>
        ...
        <script type="text/javascript">
            jQuery(function($){
                $('#map_canvas').gmap3({
                    marker:{
                        address: '2500 State St, Salt Lake City, UT 84115' 
                    },
                        map:{
                        options:{
                        zoom: 17,
